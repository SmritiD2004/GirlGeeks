...
export default function Chatbot() {
  const { t } = useLanguage();
  const streamlitUrl =
    'https://arthsakhi-y8wpf8bnhtdzegoqcgm4ji.streamlit.app/';
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center max-w-md">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">
            {t('talkToArthSakhi') || 'Talk to ArthSakhi'}
          </h3>
          ...
          >
            {t('openFinancialChatbot') || 'Open Financial Chatbot'}
          </a>
          <p className="text-sm text-gray-500 mt-4">
            {t('opensInNewWindow') || 'Opens in a new window'}
          </p>
        </div>
      </div>
    </div>
